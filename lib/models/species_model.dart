...
class SwapiResponse {
  ...
  factory SwapiResponse.fromJson(String str) =>
      SwapiResponse.fromMap(json.decode(str));
  ...
  factory SwapiResponse.fromMap(Map<String, dynamic> json) => SwapiResponse(
        ...
        species: json["results"] == null
            ? []
            : List<Species>.from(
                json["results"]!.map((x) => Species.fromMap(x))),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "results": species == null
            ? []
            : List<dynamic>.from(species!.map((x) => x.toMap())),
      };
}
...
class Species {
  ...
  Map<String, dynamic> toMap() => {
        ...
        "language": language,
        "people":
            people == null ? [] : List<dynamic>.from(people!.map((x) => x)),
...
final designationValues = EnumValues(
    {"reptilian": Designation.REPTILIAN, "sentient": Designation.SENTIENT});
