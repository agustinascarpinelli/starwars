...
class SwapiState {
  ...
  SwapiState({this.planet, this.error ="no error",this.species, this.isConnected = false, this.isLoading = false});
 ...
 SwapiState.fromJson(Map<String, dynamic> json)
      : species = (json['species'] as List<String>?)
        ...
        planet = json['planet'] != null ? PlanetResponse.fromJson(json['planet'] as String) : null,
